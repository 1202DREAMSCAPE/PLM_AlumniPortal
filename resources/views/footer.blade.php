  <!--Footer-->
  <footer class="absolute w-screen h-screen">
    <img class="w-screen h-screen absolute " src="/images/Footer.png" />
    <div class="absolute justify-center flex flex-row justify-center inline-flex">
        <!--PLM SIDE-->
        <div class="pt-2 flex flex-col">
            <div class="flex flex row">
                <img class="w-[6rem] h-[6rem] ml-[5rem] mt-5" src="/images/Logo only.png" />
                <div class=" py-4 ml-9 flex flex-col">
                    <h1 class="text-2xl font-bold mt-8 -mb-5 text-white-10">
      ...
      <div class="absolute justify-center flex flex-col items-center inline-flex">
        <div class="flex flex-row pt-[7px] pl-[35px] w-3/4 flex flex-col">
